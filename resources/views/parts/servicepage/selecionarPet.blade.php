    ...
    <div class="border rounded p-3 text-center mx-auto">
            ...
            @foreach ($pets as $pet)
                ...
                <div class="p-2 mx-3 border d-flex flex-column rounded">
                    <label class="form-check-label" for="petId{{ $pet->id_pet }}">
                        <img src="{{ asset('storage/images/pets/' . $pet->img_pet) }}" width="250px" class="rounded" alt="Imagem do Pet">
                    </label>
                    <div class="d-flex mx-auto">
                        <input class="form-check-input" onclick="toggleActiveClass({{ $pet->id_pet }})" type="radio" name="selectPet" id="petId{{ $pet->id_pet }}"
                            value="option2">
        ...
        <div class="w-100 text-center d-flex flex-column mt-3">
            <div class="d-flex justify-content-around my-2">
                ...
                <a onclick="agendamento()" class="btn btn-warning p-1"
                    style="white-space: nowrap; font-family: 'Cotane Beach', sans-serif; font-size:20px;">
                    Continuar
                </a>
            </div>
