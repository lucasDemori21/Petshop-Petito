...
<div style="max-width: 600px; margin: 20px auto; background-color: #fff; padding: 20px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
    ...
    <section style="margin-bottom: 20px;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
            <thead>
                <tr>
                    <th style="border: 1px solid #ddd; padding: 8px; text-align: left; background-color: #f2f2f2;">Descrição</th>
                    <th style="border: 1px solid #ddd; padding: 8px; text-align: left; background-color: #f2f2f2;">Quantidade</th>
                    <th style="border: 1px solid #ddd; padding: 8px; text-align: left; background-color: #f2f2f2;">Preço Unitário</th>
            ...
            <tbody>
                ...
                @foreach ($data['resumeProd'] as $prod)
                    <tr>
                        ...
                        <td style="border: 1px solid #ddd; padding: 8px; text-align: left;">R$ {{ str_replace('.', ',', $prod['valorUnitario']) }}</td>
                        <td style="border: 1px solid #ddd; padding: 8px; text-align: left;">R$ {{ str_replace('.', ',', $prod['total']) }}</td>
